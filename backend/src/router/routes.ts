...
const models: TsoaRoute.Models = {
    ...
    "DeckDTO": {
        ...
        "properties": {
            ...
            "reducedSideboard": {"dataType":"array","array":{"dataType":"refAlias","ref":"DeckCard"},"required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/decks',
            ...
            ...(fetchMiddlewares<RequestHandler>(DeckController.prototype.getDecks)),

            function DeckController_getDecks(request: any, response: any, next: any) {
            const args = {
            };
